...
export default function Navbar({
  ...
  const submenus = {
    ...
    Account: isAuthenticated
      ? ["FAQs", "Help and contact", "Sign out"]
      : ["FAQs", "Help and contact", "Sign in or create account"],
  };

  const dropdownData = {
    "Fresh Fruit & Vegetables boxes": ["Fresh Fruits", "Fresh Vegetables"],
    "Ethics & ethos": [
      "Why Farmlet?",
      "Why Organic?",
    ...
    "Dairy & eggs": ["Milk", "Eggs", "Yogurts", "Cheese", "Butter & cream"],
  };
  ...
  const mobileDropdownContent = {
    ...
    About: [
      ...
      {
        title: "Growers & makers",
        desc: "Meet the farmers who grow your food",
      },
      { title: "Our restaurant", desc: "Our award-winning organic restaurant" },
      { title: "Careers", desc: "Learn more about careers at Farmlet" },
      {
        title: "Wicked Leeks magazine",
        desc: "Opinion pieces, ethical lifestyle & more",
      },
    ],
  };
  ...
  const getProductsForCurrentCategory = () => {
    ...
    groupList.forEach((sub) => {
      // matching DB keys
      const dbKey = Object.keys(productsData).find(
    ...
    return popupSidebarNames.map((name) => {
      ...
      for (const child of children) {
        const catObj = categories.find(
          (c) => c && c.name && c.name.toLowerCase() === child.toLowerCase(),
        );
      ...
      <nav className="main-navbar">
        ...
        <div className="nav-right">
          ...
          <div className="search-box" style={{ position: "relative" }}>
            <input
              type="text"
              placeholder="Search OrganicVibes"
              value={searchQuery}
              ...
              <div className="search-suggestions-dropdown">
                {searchResults.map((prod) => (
                  ...
                  >
                    <img
                      src={
                        prod.image_url && prod.image_url.startsWith("/uploads")
                  ...
                  {searchResults.map((prod) => (
                    ...
                    >
                      <img
                        src={
                          prod.image_url &&
                          prod.image_url.startsWith("/uploads")
                            ? `${window.ENV.BACKEND_API}${prod.image_url}`
                            : prod.image_url
                        }
                        alt=""
